...
-- Tiempo de generación: 21-06-2023 a las 00:57:13
...
CREATE TABLE IF NOT EXISTS `detalles_compras` (
  ...
  UNIQUE KEY `id_compra` (`id_compra`) USING BTREE,
