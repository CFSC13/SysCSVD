...
<div class="card shadow mb-4 mx-auto" >
            ...
            <div class="card-header py-3" id="headingTwo">
                <h6 class="m-0 font-weight-bold text-primary" data-toggle="collapse" data-target="#collapseListado" aria-expanded="true" aria-controls="collapseListado"><a href="modulos/clientes_catalogo.php" title="Catalogo Clientes" alt="Catalogo Clientes" target="_blank">Catalogo de Clientes <i class="fa fa-list-alt"></i></a> </h6>
